...
- `patterns/composable-claim-graph/src/resolver.ts`
- `patterns/composable-claim-graph/src/compose.ts`
- `patterns/composable-claim-graph/examples/temporal-validity-with-revocation.json`
- `patterns/composable-claim-graph/src/delegation-depth-guard.ts`
- `patterns/composable-claim-graph/src/compose-with-cycle-guard.ts`
- `patterns/composable-claim-graph/src/intersection-types.ts`
- `patterns/composable-claim-graph/src/compose-with-trust-scoring.ts`
- `patterns/composable-claim-graph/src/compose-with-freshness.ts`
- `patterns/composable-claim-graph/src/compose-with-freshness-staleness.ts`
